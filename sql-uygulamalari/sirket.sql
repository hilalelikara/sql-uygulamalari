...
INSERT INTO unvan VALUES ('MİHENDİS'),('İK UZMANI'),('TEKNİSYEN');
...
('GÜVENLİ İNTERNET','2017.05.15','2020.06.09'),
...
('Ömer','BUZDAĞI','E','1980.10.30',5,'2001.08.10',1,2,40,4800,400),
...
('Selen','BUZDAĞI','K','2015.09.11',1,17),
('Akif','ÇAKIR','E','2018.01.05',1,19),
('Halide','ESMER','K','2017.12.10',8,6),
('Jİlide','BUZDAĞI','K','2016.03.03',6,17),
('Elif','BUZDAĞI','K','2013.11.11',2,17);
